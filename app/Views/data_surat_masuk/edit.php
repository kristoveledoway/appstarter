        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('data_surat_masuk/edit/' . $users['no_surat_masuk']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $users['no_surat_masuk'] ?>">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group date">
                                                ...
                                                <input placeholder="Masukan Tanggal Surat" type="text" class="form-control datepicker" name="tgl_surat" value="<?php echo $users['tgl_surat'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group date">
                                                ...
                                                <input placeholder="Masukan Tanggal Surat Diterima" type="text" class="form-control datepicker" name="tgl_diterima" value="<?php echo $users['tgl_diterima'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
