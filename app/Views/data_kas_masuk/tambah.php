...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tambah Data Kas Masuk</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Tambah Data Kas Masuk</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Data Kas Masuk</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Masukan Keterangan Kas Masuk">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group date">
                                                ...
                                                <input placeholder="Masukan Tanggal Kas Masuk" type="text" class="form-control datepicker" name="tgl">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="jumlah_masuk" id="jumlah_masuk" class="form-control" placeholder="Masukan Jumlah Kas Masuk">
                                        </div>
                                    </div>
