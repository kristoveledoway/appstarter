...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Data Kas Masuk</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Edit Data Kas Masuk</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Data Kas Masuk</h3>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo base_url('data_kas_masuk/edit/' . $users['kode']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
